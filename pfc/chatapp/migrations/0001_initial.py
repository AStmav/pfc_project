# Generated by Django 4.2.30 on 2026-04-10 22:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('direct', 'Direct (1:1)'), ('group', 'Group')], default='direct', max_length=16)),
                ('title', models.CharField(blank=True, help_text='For group chats; usually empty for direct.', max_length=255)),
