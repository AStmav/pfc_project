...
INSTALLED_APPS = [
    ...
    'django_rest_framework_simplejwt.token_blacklist.models',
    'django_rest_framework_simplejwt.token_blacklist.admin',
    'django_rest_framework_simplejwt.token_blacklist.apps',
]
